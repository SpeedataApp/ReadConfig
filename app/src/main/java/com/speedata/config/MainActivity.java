...
public class MainActivity extends AppCompatActivity {
    ...
    private void showView() {
        if (!CommonUtils.isExists()) {
            setTitle(CommonUtils.getAppVersionName(this) + "    " + getString(R.string.config_not_exists));
            mRead = JSON.parseObject(CommonUtils.getFromAssets(this), ReadBean.class);
        } else {
            setTitle(CommonUtils.getAppVersionName(this) + "    " + getString(R.string.config_content));
